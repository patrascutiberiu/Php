...
Lvl_User_Card INT NOT NULL,
Atk_User_Card INT NOT NULL,
Def_User_Card INT NOT NULL,
Pow_User_Card INT NOT NULL,
Exp_User_Card INT NOT NULL,
Id_User INT NOT NULL,
Id_Card INT NOT NULL,
CONSTRAINT FK_Id_User_Card FOREIGN KEY (Id_User)REFERENCES USERS(Id_User),
CONSTRAINT FK_Id_Card_USER_CARDS FOREIGN KEY(Id_Card)REFERENCES CARDS(Id_Card),
CONSTRAINT PK_USER_CARDS PRIMARY KEY(Id_User, Id_Card)
) ENGINE INNODB DEFAULT CHARSET UTF8;

CREATE TABLE DECKS(
Id_Deck INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
